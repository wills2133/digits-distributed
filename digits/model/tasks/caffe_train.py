...
class CaffeTrainTask(TrainTask):
    ...
    def before_run(self):
        ...
        # path = '/home/wills/Projects/digits/digits/jobs/VGG_VOC0712_SSD_300x300.log'
        # print 'path', self.path(self.CAFFE_LOG)
        self.caffe_log = open(self.path(self.CAFFE_LOG), 'a') # add immediately path to CAFFE_LOG
    ...
    def iteration_to_epoch(self, it):
        # print '********self.train_epochs ', self.train_epochs
        # print '********self.solver.max_iter ', self.solver.max_iter
        # print '********self.result ', float(it * self.train_epochs) / self.solver.max_iter
