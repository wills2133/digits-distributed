...
def CreateTestNet(test_net_file2, test_data2, test_batch_size2, label_map_file2, name_size_file2):
    ...
    with open(test_net_file2, 'w') as f:
        print('name: "{}_test"'.format(model_name), file=f)
        print(net.to_proto(), file=f)
    # shutil.copy(test_net_file2, job_dir)
...
def CreateSolver(solver_file2,
    train_net_file2, test_net_file2, snapshot_prefix2, 
    base_lr2, iter_size2, solver_type, device_id2=0):
    ...
    solver = caffe_pb2.SolverParameter(
            train_net=train_net_file2,
            test_net=[test_net_file2],
            snapshot_prefix=snapshot_prefix2,
            **solver_param)

    with open(solver_file2, 'w') as f:
        print(solver, file=f)
