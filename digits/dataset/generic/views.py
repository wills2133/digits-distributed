...
################################################
@blueprint.route('/dataset_server/<extension_id>.json', methods=['POST'])
@blueprint.route('/dataset_server/<extension_id>', methods=['POST', 'GET'])
def dataset_server(extension_id):
